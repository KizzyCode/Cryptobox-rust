...
// - Replaced `::core::` with `::std::`
// - Added alignments:
//   - `align(64)` for `crypto_generichash_blake2b_state`
//   - `align(16)` for `crypto_onetimeauth_poly1305_state`
//   - `align(16)` for `crypto_aead_aes256gcm_state_` (also patched alignment test)
...
fn bindgen_test_layout_crypto_generichash_blake2b_state() {
	...
	assert_eq!(
		unsafe {
			&(*(::std::ptr::null::<crypto_generichash_blake2b_state>())).opaque as *const _
				as usize
		},
		0usize,
		concat!(
...
fn bindgen_test_layout_crypto_secretstream_xchacha20poly1305_state() {
	...
	assert_eq!(
		unsafe {
			&(*(::std::ptr::null::<crypto_secretstream_xchacha20poly1305_state>()))._pad
				as *const _ as usize
		},
		44usize,
		concat!(
...
pub struct randombytes_implementation {
	pub implementation_name: ::std::option::Option<unsafe extern "C" fn() -> *const ::std::os::raw::c_char>,
	...
	pub buf: ::std::option::Option<unsafe extern "C" fn(buf: *mut ::std::os::raw::c_void, size: usize)>,
...
fn bindgen_test_layout_randombytes_implementation() {
	...
	assert_eq!(
		unsafe {
			&(*(::std::ptr::null::<randombytes_implementation>())).stir as *const _ as usize
		},
		16usize,
		concat!(
			"Offset of field: ",
